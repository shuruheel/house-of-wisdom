...
class LegalDocumentProcessor:
    ...
    def process_legal_document(self, file_path: str):
        try:
            ...
            logging.info(f"Processing {len(chapters)} chapters for {file_path}")

            for chapter_index, chapter in enumerate(chapters):
                chapter_chunks = self.split_large_chunk(chapter)
    ...
    def create_batch_request(self, chunk: str, request_id: str):
        prompt = f"""
        ...
        Here is the desired JSON structure:
        {
          ...
          "doc_number": "integer",
          "full_title": "string",
          "enactment_date": "date", // YYYY-MM-DD format
          "chapters": [
            {
              ...
              "sections": [
                {
                  ...
                  "entities": [
                    "string", // For simple entity mentions
                    {
                      "entity": "string",
                      "description": "string" // Optional description or details about the entity
                    }
                  ],
                  "concepts": [
                    "string", // For simple term definitions
                    {
                      "term": "string",
                      "definition": "string"
                    }
                  ...
                  "conditions": [
                    ...
                    {
                      "condition": "string",
                      "details": "string" // Optional details about the condition
                    }
                  ],
                  "consequences": [
                    "string",
                    {
                      "consequence": "string",
                      "details": "string" // Optional details about the consequence
                    }
                  ]
                }
              ]
        ...
        * Use dictionaries within "scope", "definitions", "substantive_provisions", "conditions", and "consequences" when additional details or structure are needed.
        * Ensure that all sections have titles.
        * Maintain the YYYY-MM-DD format for the enactment date.
